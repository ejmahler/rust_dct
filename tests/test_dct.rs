...
fn test_dct1_accuracy() {
    test_dct1::compare_known_length(&[1_f32, 1_f32], &[1_f32, 0_f32]);
    test_dct1::compare_known_length(&[1_f32, 2_f32, 3_f32, 5_f32],
                                    &[8_f32, -2.5_f32, 0.5_f32, -1_f32]);
    test_dct1::compare_known_length(&[1_f32, 2_f32, 3_f32, 5_f32, 1_f32, -3_f32],
                                    &[10.0_f32,
...
fn test_dct2_accuracy() {
    test_dct2::compare_known_length(&[1_f32, 1_f32], &[2_f32, 0_f32]);
    test_dct2::compare_known_length(&[1_f32, 1_f32, 1_f32, 1_f32], &[4_f32, 0_f32, 0_f32, 0_f32]);
    test_dct2::compare_known_length(&[4_f32, 1_f32, 6_f32, 2_f32, 8_f32],
                                    &[21_f32,
                                      -4.39201132_f32,
                                      2.78115295_f32,
                                      -1.40008449_f32,
...
fn test_dct3_accuracy() {
    test_dct3::compare_known_length(&[2_f32, 0_f32], &[1_f32, 1_f32]);
    test_dct3::compare_known_length(&[4_f32, 0_f32, 0_f32, 0_f32], &[2_f32, 2_f32, 2_f32, 2_f32]);
    test_dct3::compare_known_length(&[21_f32,
                                      -4.39201132_f32,
                                      2.78115295_f32,
                                      -1.40008449_f32,
                                      7.28115295_f32],
...
fn test_dct4_accuracy() {
    test_dct4::compare_known_length(&[0_f32, 0_f32, 0_f32, 0_f32, 0_f32],
                                    &[0_f32, 0_f32, 0_f32, 0_f32, 0_f32]);
    test_dct4::compare_known_length(&[1_f32, 1_f32, 1_f32, 1_f32, 1_f32],
                                    &[3.19623_f32,
                                      -1.10134_f32,
                                      0.707107_f32,
                                      -0.561163_f32,
                                      0.506233_f32]);
    test_dct4::compare_known_length(&[4.7015433_f32,
                                      -11.926178_f32,
                                      27.098675_f32,
                                      -1.9793236_f32],
                                    &[9.36402_f32, -19.242455_f32, 17.949997_f32, 32.01607_f32]);
    test_dct4::compare_known_length(&[6_f32, 9_f32, 1_f32, 5_f32, 2_f32, 6_f32, 2_f32, -1_f32],
                                    &[23.9103_f32,
                                      0.201528_f32,
                                      5.36073_f32,
                                      2.53127_f32,
